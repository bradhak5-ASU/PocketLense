# PocketLense coding style

Keep the code straightforward and easy to explain.

- Use Angular, C#, ASP.NET Core, Entity Framework Core, and PostgreSQL.
- Keep Angular HTML, CSS, and TypeScript in separate files.
- Use clear names, four-space indentation, and small functions.
